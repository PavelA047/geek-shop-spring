...
import com.geekbrains.products.repositories.ProductRepository;
...
public class ProductService {
    ...
    public void saveProduct(ProductDTO productDTO) {
        if (productDTO.getId() != null) {
            ...
            oldProduct.setCategory(categoryService.getCategory(productDTO.getCategoryId()));
            oldProduct.setVendorCode(productDTO.getVendorCode());
            oldProduct.setTitle(productDTO.getTitle());
            oldProduct.setShortDescription(productDTO.getShortDescription());
            oldProduct.setFullDescription(productDTO.getFullDescription());
